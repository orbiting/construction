...
export default ({url}) => {
  ...
  return (
    <Layout meta={meta} url={url} cover={(
      ...
      <p>
        Wollen Sie uns unterstützen, indem Sie das Manifest öffentlich aufhängen? Das würde uns freuen! Holen Sie Ihr kostenloses DIN-A3-Poster-Manifest hier bei uns im Hotel Rothaus ab. Bitte kurz vorher Bescheid sagen: <a style={{whiteSpace: 'nowrap'}} href='mailto:office@project-r.construction'>office@project-r.construction</a></p>
