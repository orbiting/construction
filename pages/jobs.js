...
export default ({url}) => {
  ...
  return (
    <Layout meta={meta} url={url} cover={(
      ...
      <p>Wir sind daran, die beste User-Experience für journalistische Inhalte zu bauen. Und die besten Tools für digitale Journalistinnen. Wir sind eine kleine, qualifizierte, hart arbeitende, leidenschaftliche und fröhliche Crew. Wir arbeiten sehr eng mit dem ganzen Team von Project R zusammen. Wir machen alles, von den Requirements bis zum Hosting. Wir sind vollständig Open-Source. Code, den wir schon veröffentlicht haben, findest du hier: <a target="_blank" href='https://github.com/orbiting'>github.com/orbiting</a></p>
      ...
      <p>Thomas Preusse (links auf dem Bild): Frontend Engineer, ehemals Interactive&nbsp;Things und NZZ. Begeistert von Daten-Visualisierungen und ihren journalistischen Anwendungen. Versucht das Leben selbst in einen Bubble-Chart zu verwandeln. Verwendet nie eine Technologie, die schon in Beta ist.</p>
