  ...
  return (
    <Layout meta={meta} url={url} cover={(
      ...
      <figure style={{margin: '0 0 10px'}}>
        <img
          src='http://localhost:8000/images/optimized/hammett_mccarthy.jpg'
            ...
            <tr>
              ...
              <td>
                <img
                  ...
                  src='http://localhost:8000/images/optimized/project_r_logo.svg' /><br />
                Genossenschaft
              </td>
              <td>
                <img
                  style={{height: 40, marginLeft: -10, marginBottom: 10}}
                  src='http://localhost:8000/images/optimized/magazine_logo.png' /><br />
                Aktiengesellschaft
              </td>
            </tr>
            <tr>
      ...
      <p>
        <img
          src='http://localhost:8000/images/optimized/vorstand_genossenschaft.jpg'
