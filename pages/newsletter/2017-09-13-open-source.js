  ...
  return (
    ...
    >
      ...
      <figure style={{margin: '0 0 10px'}}>
        <img
          src='http://localhost:8000/images/optimized/nl7-frankenstein.jpg'
      ...
      <figure style={{margin: '0 0 10px'}}>
        <img
          src='http://localhost:8000/images/optimized/nl7-warroom.jpg'
      ...
      <p>
        <img
          src='http://localhost:8000/images/optimized/nl7-error.jpg'
      ...
      <p>
        <img
          src='http://localhost:8000/images/optimized/nl7-kosmos.jpg'
