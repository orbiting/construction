...
export default ({url}) => {
  ...
  return (
    ...
    >
      ...
      <p><strong>Schönheit.</strong> Wer ein Crowdfunding bei einem professionellen Anbieter macht, muss auch dessen Layout übernehmen. Und das hat den Charme eines Schrebergartens. Wir wollten dagegen Weite, Grosszügigkeit, Klarheit – ein Stück Technik mit der Eleganz eines Stücks Natur. Das nicht zuletzt, weil wir ohne Produkt antraten. Und die einzige Möglichkeit für die Vorschau auf das Produkt bestand im Stil der Kampagne.</p>

      <p><strong>Einfachheit.</strong> Der Weg, bei einer Profi-Crowdfunding-Seite zu zahlen, braucht Zeit: Man muss sich erst bei der Hauptseite registrieren, ein Passwort erstellen, bevor man irgendetwas unterstützen kann. Wir wollten den Weg zur Zahlung pfeilschnell machen: ohne Passwörter und Umwege. Nach der Philosophie des irischen Dichters (und Trinkers) Brendan Behan: «Möge die gebende Hand niemals zittern.» Ausserdem wollten wir mit unseren Verlegern so charmant, klar und direkt wie möglich reden: also von Antwortmails bis zu Fehlermeldungen alles selber texten.</p>

      <p><strong>Abonnements.</strong> Zwar ist es geplant, dass in Zukunft auch bei Profis Abonnements per Crowdfunding verkauft werden können, aber noch ist das nicht möglich. Und wir mussten Abonnements verkaufen, um nicht ein Jahr später in existenzielle Probleme zu kommen.</p>

      <p><strong>Zahlungsdaten.</strong> Crowdfunding-Agenturen geben zwar das Geld und die Mail-Adressen weiter, aber nicht die Zahlungsdaten. Auch das wäre verheerend für ein Unternehmen, das nicht eine Kick-off-Finanzierung will, sondern eine langfristige Beziehung per Abonnements.</p>
      ...
      <h3>3. Was es kostet, was es bringt</h3>
      ...
      <p>PS: Im Herbst plant Project R eine kleine Debattenreihe im neu eröffneten Europaallee-Koloss Kosmos. Die erste Veranstaltung, am 18. September, trägt den Titel «Gesünder durch Informationsdiät!». In den Monaten darauf sprechen wir über Erwachsenwerden (Taten statt Jammern), die Grenze zwischen Aktivismus und Journalismus und im Dezember zum Stand des Irrtums in der Republik. Den Link dazu finden Sie auf der Veranstaltungsseite des Kosmos: <a href='https://www.facebook.com/events/1353065808123282/'>facebook.com</a></p>
