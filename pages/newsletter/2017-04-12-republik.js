...
export default ({url}) => {
  const meta = {
    ...
    image: 'http://localhost:8000/images/optimized/rothaus_republik.jpg',
  ...
  return (
    <Layout meta={meta} url={url} cover={(
      ...
      <figure style={{margin: '0 0 10px'}}>
        <img
          src='http://localhost:8000/images/optimized/foto_manifest.jpg'
      ...
      <figure style={{margin: '0 0 10px'}}>
        <img
          src='http://localhost:8000/images/optimized/freiheitsbaum.jpg'
      ...
      <figure style={{margin: '0 0 10px'}}>
        <img
          src='http://localhost:8000/images/optimized/pressefreiheit.jpg'
      ...
      <figure style={{margin: '0 0 10px'}}>
        <img
          src='http://localhost:8000/images/optimized/ochs_waser.jpg'
          alt='' /><br />
        <figcaption style={{fontSize: 12, fontFamily: 'sans-serif', margin: 0, textAlign: 'left'}}>
