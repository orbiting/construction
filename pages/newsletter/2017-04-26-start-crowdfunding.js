...
export default ({url}) => {
  const meta = {
    ...
    description: 'TODO',
    image: 'https://assets.project-r.construction/images/rothaus_republik.jpg', //screen_crowdfunding
  ...
  return (
      ...
      <img
      src='https://assets.project-r.construction/images/pressefreiheit.jpg' //manifest_rothaus
      alt='Das Manifest hängt am Balkon des Hotel Rothaus' /><br />
      ...
      <figure style={{margin: '0 0 10px'}}>
      <img
      src='https://assets.project-r.construction/images/pressefreiheit.jpg' //taufe_logo
      alt='Das Manifest hängt am Balkon des Hotel Rothaus' /><br />
      <figcaption style={{fontSize: 10, fontFamily: 'sans-serif', margin: 0, textAlign: 'right'}} />
      </figure>
      ...
      <p>
      <br />
      PS: Um die Spannung gerecht zu teilen, werden wir Sie bis zum Abschluss des Crowdfundings am 31. Mai regelmässig über den Stand der Dinge informieren.</p> 
