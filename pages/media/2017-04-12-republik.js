...
export default ({url}) => {
  ...
  return (
    <Layout meta={meta} url={url}>
      ...
      <p><strong>Die Project-R-Crew hat heute den Namen des geplanten digitalen Magazins präsentiert: «Republik». Das Magazin soll erstmals Anfang 2018 erscheinen. In ihrem Manifest definiert das Aufbau-Team des Medienprojekts die Rolle des Journalismus in einer freiheitlichen Gesellschaft und hält damit seinen publizistischen Anspruch fest.</strong></p>
      ...
      <p>
        ...
        <strong>Aufbau der Redaktion: </strong>ab Sommer 2017<br />
