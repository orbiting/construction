...
export default ({url}) => {
  const meta = {
    ...
    image: 'https://assets.project-r.construction/imagestaufe_bern.jpg',
  ...
  return (
    <Layout meta={meta} url={url}>
      ...
      <p><em>Markttest per Crowdfunding</em></p>
      ...
      <p><strong>Die Project R Genossenschaft</strong> nimmt sich der Weiterentwicklung und Stärkung des Journalismus an. Dazu gehören Projekte wie der Bau einer digitalen Open-Source-Infrastruktur, das Durchführen von Veranstaltungen und Debatten, das Entwickeln neuer journalistischer Formate sowie die Ausbildung von jungen Journalistinnen und Journalisten.</p>
