...
export default ({url}) => {
  const meta = {
    ...
    url: 'https://project-r.construction/media/2017-01-10-hotel-rothaus'
  }
  ...
  return (
    <Layout meta={meta} url={url}>
      ...
      <p><strong>Die Aufbau-Crew von Project R hat Anfang Januar ihr provisorisches Domizil im Zürcher Kreis 4 bezogen. Sie hat die Möglichkeit erhalten, 3 Zimmer im Hotel Rothaus als Büros zu mieten. Dort treibt das Team die Konzeption und Entwicklung des Medienprojekts voran. Eine Genossenschaft sowie eine Produktions- und Vertriebs-AG stehen kurz vor der Gründung.</strong></p>

      <p>Während sich die Schweizer Verleger und Medienmanager heute an der traditionellen Dreikönigstagung treffen, krabbelt das Wickelkind der Schweizer Presse ins Licht der  Öffentlichkeit. Project R stellt seine Aufbau-Crew vor – und bezieht drei Zimmer im legendären Zürcher Hotel Rothaus als Geschäftssitz.</p>
      ...
      <p>
        <strong>Mai/Juni 2017</strong><br />
        Crowdfunding
      </p>
      <p>
        <strong>ab Sommer 2017</strong><br />
        Aufbau der Redaktion
      </p>
      <p>
        <strong>Anfang 2018</strong><br />
