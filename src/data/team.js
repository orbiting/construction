...
export const richard = {
  ...
  dob: '13.05.1987',
  title: 'Netzwerk-Organisator',
  description: 'Das Interessante am Journalismus ist, dass man mit jedem einen Grund zum Reden hat: von der Bundesrätin bis zum Bauarbeiter. Und das Interessante an einer Redaktion ist, dass die verschiedensten Leute vorbeikommen. Leute mit Ideen, mit Interessen, mit Fragen, mit Informationen – kurz: Verrückte aller Art. Richard Höchner ist unser Mann, der diese Vielfalt zusammenbringen wird. Seine Eltern lernten sich in einem kaputten Zug in Italien kennen. Der Vater kam vom Fischen, die Mutter von einer 1.-Mai-Demonstration. Das Resultat dieser Zugpanne, Richard Höchner, wuchs danach in zwei Familien auf: Die schweizerische war ruhig und seriös, die italienische laut, politisch und so herzlich wie chaotisch. Höchner besuchte die Schule in Rheineck: einer kleinen Grenzstadt, die nicht nur aussah, als käme sie aus dem Mittelalter. Sondern sich auch so anfühlte. Er floh: erst zu einem Auslandjahr nach Neuseeland, dann – noch im Gymnasium – als Trendscout zur Bieler Firma Brainstore. Für die flog er für ein Wochenende an Orte wie Tokio oder New York. Und entdeckte dort Dinge, die in Europa noch völlig unbekannt waren – wie den QR-Code zum Beispiel. Höchner machte schnell Karriere: zum Organisator von 3000 freien Mitarbeiterinnen und Mitarbeiter rund um den Planeten. 2010 wechselte er zu „Warm Decent Human Beings“ – einer Firma, die Informationsreisen für andere Firmen organisiert: Höchner führte Ingenieure, Financiers und Manager in Dinge wie Digitales Business, Detailhandel oder Marketing ein –an Orten wie Doha, Bangalore oder Bogota. Sieben Jahre flog er pro Jahr drei Mal um den Planeten. (Und veranstaltete als Hobby in Zürich Parties.) Als Resultat, sagt er, haben unter seinen Freunden kaum zwei Leute denselben Pass. Bei Project R wird Höchner zum ersten Mal sesshaft. Er ist zuständig für das, was er schon immer tat: dem Zusammenbringen von Leuten und Ideen. Also für die Vernetzung von Experten und Lesern aller Art. Und sonstigen Verrückten.',
